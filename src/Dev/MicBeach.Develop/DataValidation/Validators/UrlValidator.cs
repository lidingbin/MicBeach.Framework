...
namespace MicBeach.Develop.DataValidation.Validators
{
    public class UrlValidator : DataValidator
    {
        ...
        public override void Validate(dynamic value, string errorMessage)
        {
            ...
            {
                SetVerifyResult(valueAsString != null && (valueAsString.StartsWith("http://", StringComparison.InvariantCultureIgnoreCase) || valueAsString.StartsWith("https://", StringComparison.InvariantCultureIgnoreCase) || valueAsString.StartsWith("ftp://", StringComparison.InvariantCultureIgnoreCase)), errorMessage);
            }
        }
